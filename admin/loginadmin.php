...
<html lang="en">
<head>
    <title>Pakar Kedelai | Admin Masuk</title>
    <meta charset="utf-8">
...
<body>
    <div class="judul text-center">
        <p><marquee onmouseover="this.stop()" onmouseout="this.start()" scrollamount="10">Admin Masuk - Sistem Pakar Diagnosa Hama dan Penyakit Kedelai</marquee></p>
    </div>
                ...
                <form class="login form-horizontal" method="post" action=" ">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-footer text-center">
                            <p>Data Admin Hanya bisa di kelola Oleh sesama Admin</p>
                        </div>
                    </div>
                    <?php
                    if(isset($_POST["submit"])){
                        ...
                        $result = mysqli_query($konek_db, "SELECT * FROM user WHERE username = '$username' and password = '$password'");
