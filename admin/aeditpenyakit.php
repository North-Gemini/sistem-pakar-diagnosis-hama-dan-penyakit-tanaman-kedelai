...
<html lang="en">
  <head>
    <title>Pakar Kedelai | Edit Hama dan Penyakit</title>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10 text-left">
          <form method="post">
            <div class="panel panel-info">
              <div class="panel-heading">EDIT DATA HAMA DAN PENYAKIT</div>
              <div class="panel-body">
                ...
                <div class="form-group">
                  <br><label class="control-label col-sm-2">TANAMAN</label>
                  <div class="col-sm-10">
                    <?php
                    $tampil = "SELECT * FROM penyakit where idpenyakit='" . $_GET['id'] . "'";
                    $sql = mysqli_query($konek_db, $tampil);
                    while ($data = mysqli_fetch_array($sql)) {
                      echo "<input type='text'  class='form-control' id='jenistanaman' name='jenistanaman' readonly value='" . $data['jenistanaman'] . "' data-error='Isi kolom dengan benar'><br>";
                    }
                    ?>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2">TERJANGKIT</label>
                  <div class="col-sm-10">
                    <?php
                    $tampil = "SELECT * FROM penyakit where idpenyakit='" . $_GET['id'] . "'";
                    $sql = mysqli_query($konek_db, $tampil);
                    while ($data = mysqli_fetch_array($sql)) {
                      echo "<input type='text'  class='form-control' id='terjangkit' name='terjangkit' readonly value='" . $data['terjangkit'] . "'><br>";
                    }
                    ?>
                  </div>
                </div>
            ...
            <div class="panel panel-info">
              <div class="panel-heading">EDIT CARA PENGENDALIAN</div>
              <div class="panel-body">
                <div class="form-group">
            ...
            if (isset($_POST['submit'])) {
              ...
              $query = "update penyakit SET namapenyakit='" . $_POST['namapenyakit'] . "', jenistanaman='" . $_POST['jenistanaman'] . "', kulturteknis='" . $_POST['kulturteknis'] . "', fisikmekanis='" . $_POST['fisikmekanis'] . "', hayati='" . $_POST['hayati'] . "', kimiawi='" . $_POST['kimiawi'] . "' WHERE idpenyakit='$id'";
